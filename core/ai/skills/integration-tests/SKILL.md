...
- Helpers:
  - Put shared helpers in a central integration-helpers location in the core package (one platform's example: `packages/core/src/helpers/integration/`, importable as `@open-mercato/core/helpers/integration/*`).
  - Module-local `__integration__/helpers/` files should re-export central helpers where possible.
  - Standalone app developers: import helpers from the core package's published integration-helpers path (example import: `@open-mercato/core/helpers/integration/*`).
...
- installs local packed package tarballs (e.g. `@open-mercato/*`, one platform's example scope) into that app
...
- MUST keep module-specific helper utilities next to tests under `<module>/__integration__/helpers/`; for shared/cross-module helpers, import from the core package's integration-helpers path (example: `@open-mercato/core/helpers/integration/*`)
