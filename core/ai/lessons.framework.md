...
This is the downstream end of the self-improving loop (decision #8): a generic lesson learned in
one consumer, once accepted by `triage-feedback`, is appended below and flows to all consumers on
their next `sync`.

<!-- Framework lessons are appended below as triage-feedback accepts them. -->
